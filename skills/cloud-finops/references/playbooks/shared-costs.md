<!-- Source: finopsfoundation/framework/_resources/project--shared-costs.md (CC BY 4.0) -->
...
Here are the roles that are involved with identifying shared costs and how they might affect overall cost allocation. For more information on jobs and roles involved with FinOps best practices and awareness, see our Framework article about key personas.
...
Run
 ...
 Focus
Identifying shared costs Developing cost split strategy
Applying shared cost models
Refining shared cost approach, Long-term strategy Automation

Splitting shared cost approach
None or Even-Split
Fixed Proportion or Proportional
Proportional or Multi-Pronged

Shared costs that may be split
Enterprise support charges
Crawl + Platform Charges
Walk + cloud volume discounts, RIs and SPs

Challenges
Multiple CSP Bill Formats Cloud Product Charges Billing Models Tagging Reconciliation
Bill Reconciliation Bill Reporting Shared Cost Model Show Back Reporting Charge Back Reporting
Shared Cost Policy, Shared Cost Design Patterns
