<!-- Source: finopsfoundation/framework/_resources/project--unit-economics.md (CC BY 4.0) -->
...
* FinOps Capabilities and Terminology to Review
...
!A chart of motivations to include unit economics in your FinOps practice
...
!Aligning key principles to help define unit economics metrics
...
!Here's a look at unit cost by FinOps maturity level
